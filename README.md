...
[![Build Status](https://bigben-dev777/PyPokerEngine.svg?branch=master)](https://bigben-dev777/PyPokerEngine)
[![Coverage Status](https://coveralls.io/repos/github/bigben-dev777/PyPokerEngine/badge.svg?branch=master)](https://coveralls.io/github/bigben-dev777/PyPokerEngine?branch=master)
[![PyPI](https://img.shields.io/pypi/v/PyPokerEngine.svg?maxAge=2592000)](https://badge.fury.io/py/PyPokerEngine)
[![license](https://img.shields.io/github/license/mashape/apistatus.svg?maxAge=2592000)](https://github.com/bigben-dev777/kyoka/blob/master/LICENSE.md)
...
1. Create PokerPlayer class which is subclass of [`PypokerEngine.players.BasePokerPlayer`](https://github.com/bigben-dev777/PyPokerEngine/blob/master/pypokerengine/players/base_poker_player.py).
...
```
If you are interested in what each callback method receives, See [AI_CALLBACK_FORMAT.md](https://github.com/bigben-dev777/PyPokerEngine/blob/master/AI_CALLBACK_FORMAT.md).
...
Please check [PyPokerGUI](https://github.com/bigben-dev777/PyPokerGUI).

<img src="https://github.com/bigben-dev777/PyPokerGUI/blob/master/screenshot/poker_demo.gif" width=500 />
...
# Documentation
For mode detail, please checkout [doc site](https://bigben-dev777.github.io/PyPokerEngine/)
